...
@Epic ("Rest Assured POC - Erudex Tests")
@Story ("Login related Assertions using Hamcrest in rest assured")
@Feature ("Performing different API Tests using Rest-Assured")
//@Listeners(TestListener.class)
public class LoginTestRA {
	
	private static final Logger logger = LogManager.getLogger(LoginTestRA.class);	
	
	private ILoginService svcLogin = new LoginServiceRAImpl();
