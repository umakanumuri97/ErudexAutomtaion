...
public class LoginPage extends ErudexPage{
    ...
    private final String pageUrl = "https://app.erudex.com/";
...
//    
    ...
    public ErudexPage login(boolean accept) {
        ...
        try {        	        	
        	...
        	if (currentUrl.equals(teacherURL) ) {        		
        		page =  new TeacherDashboardPage(driver);
        	}
        	else if (currentUrl.equals(studentURL)) {
        		page =  new StudentDashBoardPage(driver);
        	}
        	else if (currentUrl.equals(dataentryURL)) {
        		page =  new DataEntryDashboardPage(driver);
        	}
        	else if (currentUrl.equals(adminURL)) {
